function GetStarted({ page, setPage, formData, setFormData }) {
    return (
        <div className="card">
            ...
            />
            <div>
                <div className="font-bold text-lg mb-4 mt-8 " > Account </div>
                <input
                    className="w-full border-0"
                    type="text"
                    placeholder="Email"
            ...
            <br />
            <div>
                <div className="text-slate-900 text-lg font-bold mt-8 "> Date of birth </div>
                <br />
                <select
                    className="mr-4"
                    placeholder="Month"
            ...
            <div className="mt-4">
                <div className="text-slate-900 text-lg font-bold mt-8 "> Home address </div>
